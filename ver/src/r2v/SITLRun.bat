...
REM This option is useful for simulation with other types of vehicles instead of multicopters FX120_model QuadModelV tjhfault
...
REM e.g., UE4_MAP=1 equals to UE4_MAP=Grasslands  OldFactory  ModernCityBundle MountainTerrain NeighborhoodPark
SET UE4_MAP=NeighborhoodPark

REM Set the origin x,y position (m) and yaw angle (degree) at the map （566，-298）
