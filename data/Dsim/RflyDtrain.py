...
class RflyDtrain:
    ...
    def get_normal_train_data(self, mav_log_dir, save_path, ctrlSeq, fmode):
        ...
        for key, value in timestamp.items():
            ...
            if value is not None:
                ...
                if fmode == '5-motor03-flag4-085-normal-r2vo' and key == '2_9':
                    temp_df = sensor_combined_df.loc[mask, columns_to_read].head(150)
                else:
