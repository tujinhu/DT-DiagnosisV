...
if __name__ == "__main__":
    ...
    # 21-maneuverability-f1  31-maneuverability-f2  41-maneuverability-f3  51-maneuverability-f4  61-maneuverability-f2y  71-maneuverability-f3y
    fault = False
    v2v = True
    r2vo = False
    
    fmode = '21-maneuverability-f1'
    phase = ['2_3', '2_6','2_8']
    source = 'Draw'
    target = 'Dsim'
